...
mkdir -p /opt/boot
wget -4 --no-check-certificate -O /opt/boot/boot0.bin https://raw.githubusercontent.com/orangepi-xunlong/OrangePiH5_external/master/OrangePiH5_ZeroPlus2_EMMC_boot0.bin 
wget -4 --no-check-certificate -O /opt/boot/uboot.bin https://raw.githubusercontent.com/orangepi-xunlong/OrangePiH5_external/master/OrangePiH5_ZeroPlus2_EMMC_uboot.bin
